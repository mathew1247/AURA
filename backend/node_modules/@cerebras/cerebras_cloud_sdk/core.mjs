...
import { CerebrasError, APIError, APIConnectionError, APIConnectionTimeoutError, APIUserAbortError, } from "./error.mjs";
...
export const ensurePresent = (value) => {
    if (value == null)
        throw new CerebrasError(`Expected a value to be given but received ${value} instead.`);
    return value;
};
/**
