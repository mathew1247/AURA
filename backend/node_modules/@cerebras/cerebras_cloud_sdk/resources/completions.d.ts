...
export declare class Completions extends APIResource {
     ...
     * ```
     */
    create(params: CompletionCreateParamsNonStreaming, options?: Core.RequestOptions): Core.APIPromise<Completion>;
    create(params: CompletionCreateParamsStreaming, options?: Core.RequestOptions): Core.APIPromise<Stream<Completion.CompletionResponse>>;
    create(params: CompletionCreateParamsBase, options?: Core.RequestOptions): Core.APIPromise<Stream<Completion.CompletionResponse> | Completion>;
}
export type Completion = Completion.CompletionResponse | Completion.CompletionChunkResponse | Completion.ErrorChunkResponse;
export declare namespace Completion {
    ...
    namespace CompletionChunkResponse {
        interface Choice {
            index: number;
